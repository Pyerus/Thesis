...
public class NPCMovementModified : MonoBehaviour
{
    // Serializable
    ...
    private PathfindModifiedDijkstra pathfinder;
    ...
    private void Start()
    {
        ...
        pathfinder = gameObject.GetComponent<PathfindModifiedDijkstra>();
